...
/datum/controller/subsystem/title/Initialize()
	var/dat
	if(!fexists("[global.config.directory]/bluemoon/bluemoon_title.txt")) // SPLURT EDIT - original title_html.txt // BLUEMOON EDIT
		to_chat(world, span_boldwarning("CRITICAL ERROR: Unable to read bluemoon_title.txt, reverting to backup title html, please check your server config and ensure this file exists.")) // BUBBER EDIT - original title_html.txt // BLUEMOON EDIT
		dat = DEFAULT_TITLE_HTML
	else
		dat = file2text("[global.config.directory]/bluemoon/bluemoon_title.txt") // SPLURT EDIT - original title_html.txt // BLUEMOON EDIT
